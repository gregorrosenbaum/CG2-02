...
define(["jquery"], 
    ...
    var HtmlController = function(scene,animation) {
        ...
        $(document).keypress((function(event) {
            ...
            /*/
            var keyToRobot = {
				49: "rotateHead", 33: "rotateHead",  // Push "1"
            	50: "rotateHead", 34: "rotateLeftArm",  // Push "2"
            	51: "rotateHead", 167: "rotateHead",  // Push "3"
            };
            ...
            if(keyToAxis[keynumber]) {
          	...
          	/*/
            if(keyToRobot[keynumber]) {
                scene.rotate(keyToRobot[keynumber], keynumber<97? -5 : 5);
            }
